...
private:
    ...
    */
    ...
    /**
    * Used internally for generated JSON will be (formatted or not)
    *
    * @param tabs - Used to track tree depth (or not when -1)
    * @return int - byte count.
    */
    int generateJSON(char** genbuf, bool comma = false, int pos = 0, int tabs = -1) const;
...
public:
    ...
    */
    ...
    /**
    * Returns a pointer to a NULL terminated string containing JSON
    * dynamically generated by this instance.  The class manages
    *
    *
    * @return const char* - returns a pointer to an interal dynamically generated buffer of JSON that represents what this object contains
    */
    const char * getJSON() const;

    /**
    * Returns a pointer to a NULL terminated string containing formatted JSON
    * dynamically generated by this instance.  The class manages
    *
    *
    * @return const char* - returns a pointer to an interal dynamically generated buffer of JSON that represents what this object contains
    */
    const char * getJSONFormatted() const;
